...
@click.option("--gen-test", is_flag=True, default=False, help="Generate a new test from template.")
...
def cmd(
    ...
    try:
        written = copy_block(
            cfg, from_group, src_name, dst_name, dst_group=to_group, gen_test=gen_test
        )
